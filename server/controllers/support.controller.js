...
exports.replyToTicket = async (req, res) => {
  ...
  const msg = await svc.addMessageToTicket(req.params.id, req.user.id, senderType, message);
...
exports.getTicketById = async (req, res) => {
  const ticket = await svc.getTicketById(req.params.id, { userId: req.user.id, role: req.user.role });
