...
//   useRequireAuth("driver"); // Adapts based on passing "customer" or "driver"
...
//   //   if (loading) return <div className="p-8 text-center text-sm text-slate-400">Updating status boards...</div>;

//   return (
//     <DashboardLayout role={"driver"} title="Support Requests Status">
