...
export default function SupportWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="card fixed mb-16 sm:mb-0 bottom-5 right-5 z-40 w-[90vw] max-w-sm h-[630px] sm:h-[560px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden animate-in">
