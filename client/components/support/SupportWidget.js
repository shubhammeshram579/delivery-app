    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-5 right-5 z-40 w-14 h-14 bg-primary-600 hover:bg-primary-700 rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-105"
        >
      ...
      {open && (
        <div className="fixed bottom-5 right-5 z-40 w-[90vw] max-w-sm h-[560px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden animate-in">
          ...
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3.5 bg-primary-600 text-white flex-shrink-0">
